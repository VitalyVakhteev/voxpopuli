...
COPY --from=build /home/app/target/voxpopuli-0.0.4.jar /app/voxpopuli-0.0.4.jar

EXPOSE 8080

# Define the entry point that runs the application
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","voxpopuli-0.0.4.jar"]
